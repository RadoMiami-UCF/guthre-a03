...
final class PasswordStrengthValueMeaning {
    /*
    This class only has these values since it wouldn't make much sense to put them in both of the other classes.
    Hopefully that's lazy enough to qualify as good code.
     */
